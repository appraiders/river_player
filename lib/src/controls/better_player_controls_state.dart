...
abstract class BetterPlayerControlsState<T extends StatefulWidget> extends State<T> {
  ...
  void _showQualitiesSelectionWidget() {
    ...
    final sortedTracks = [...(asmsTracks..sort((a, b) => (b.height ?? 0).compareTo(a.height ?? 0)))];

    final List<String> asmsTrackNames = sortedTracks.map((track) => _getTrackName(track)).toList();
